...
const WRITER_INFO const_writer_info_default =
{
    ...
    .writer_sw_ver  = "V00.04.02",   // "V01.23.45" "01.23" is writer fw version, "45" is HMI fw version
...
void ftd_mw_sys_info_manager_fw_info_dump(FW_INFO* p_fw_info)
{
    ...
    JYMC_LOG_RAW(" pid_info.reserved[6] :              %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x %02x\n",
        ...
        p_fw_info->st_pid_info.reserved[24], p_fw_info->st_pid_info.reserved[25], p_fw_info->st_pid_info.reserved[26], p_fw_info->st_pid_info.reserved[27]);
