...
void FTDWriter_PinConfigure_init_eadc0(void)
{
    SYS->GPB_MFPL &= ~(SYS_GPB_MFPL_PB7MFP_Msk | SYS_GPB_MFPL_PB6MFP_Msk | SYS_GPB_MFPL_PB3MFP_Msk | SYS_GPB_MFPL_PB2MFP_Msk);
    SYS->GPB_MFPL |= (SYS_GPB_MFPL_PB7MFP_EADC0_CH7 | SYS_GPB_MFPL_PB6MFP_EADC0_CH6 | SYS_GPB_MFPL_PB3MFP_EADC0_CH3 | SYS_GPB_MFPL_PB2MFP_EADC0_CH2);

    return;
}

void FTDWriter_PinConfigure_deinit_eadc0(void)
{
    SYS->GPB_MFPL &= ~(SYS_GPB_MFPL_PB7MFP_Msk | SYS_GPB_MFPL_PB6MFP_Msk | SYS_GPB_MFPL_PB3MFP_Msk | SYS_GPB_MFPL_PB2MFP_Msk);
...
void FTDWriter_PinConfigure_init_epwm0(void)
{
...
void FTDWriter_PinConfigure_deinit_epwm0(void)
{
    SYS->GPD_MFPH &= ~(SYS_GPD_MFPH_PD14MFP_Msk);
...
void FTDWriter_PinConfigure_init_i2c1(void)
{
...
void FTDWriter_PinConfigure_deinit_i2c1(void)
{
    SYS->GPB_MFPL &= ~(SYS_GPB_MFPL_PB1MFP_Msk | SYS_GPB_MFPL_PB0MFP_Msk);
...
void FTDWriter_PinConfigure_init_qspi0(void)
{
...
void FTDWriter_PinConfigure_deinit_qspi0(void)
{
    SYS->GPC_MFPL &= ~(SYS_GPC_MFPL_PC5MFP_Msk | SYS_GPC_MFPL_PC4MFP_Msk | SYS_GPC_MFPL_PC3MFP_Msk | SYS_GPC_MFPL_PC2MFP_Msk | SYS_GPC_MFPL_PC1MFP_Msk | SYS_GPC_MFPL_PC0MFP_Msk);
...
void FTDWriter_PinConfigure_init_sd1(void)
{
    SYS->GPG_MFPH &= ~(SYS_GPG_MFPH_PG15MFP_Msk | SYS_GPG_MFPH_PG14MFP_Msk | SYS_GPG_MFPH_PG13MFP_Msk | SYS_GPG_MFPH_PG12MFP_Msk | SYS_GPG_MFPH_PG11MFP_Msk | SYS_GPG_MFPH_PG10MFP_Msk | SYS_GPG_MFPH_PG9MFP_Msk);
    SYS->GPG_MFPH |= (SYS_GPG_MFPH_PG15MFP_SD1_nCD | SYS_GPG_MFPH_PG14MFP_SD1_CLK | SYS_GPG_MFPH_PG13MFP_SD1_CMD | SYS_GPG_MFPH_PG12MFP_SD1_DAT0 | SYS_GPG_MFPH_PG11MFP_SD1_DAT1 | SYS_GPG_MFPH_PG10MFP_SD1_DAT2 | SYS_GPG_MFPH_PG9MFP_SD1_DAT3);

    return;
}

void FTDWriter_PinConfigure_deinit_sd1(void)
{
    SYS->GPG_MFPH &= ~(SYS_GPG_MFPH_PG15MFP_Msk | SYS_GPG_MFPH_PG14MFP_Msk | SYS_GPG_MFPH_PG13MFP_Msk | SYS_GPG_MFPH_PG12MFP_Msk | SYS_GPG_MFPH_PG11MFP_Msk | SYS_GPG_MFPH_PG10MFP_Msk | SYS_GPG_MFPH_PG9MFP_Msk);
...
void FTDWriter_PinConfigure_init_spi0(void)
{
...
void FTDWriter_PinConfigure_deinit_spi0(void)
{
    SYS->GPA_MFPL &= ~(SYS_GPA_MFPL_PA3MFP_Msk | SYS_GPA_MFPL_PA2MFP_Msk | SYS_GPA_MFPL_PA1MFP_Msk | SYS_GPA_MFPL_PA0MFP_Msk);
...
void FTDWriter_PinConfigure_init(void)
{
    ...
    FTDWriter_PinConfigure_init_eadc0();
    FTDWriter_PinConfigure_init_emac();
    FTDWriter_PinConfigure_init_epwm0();
    FTDWriter_PinConfigure_init_i2c1();
    ...
    FTDWriter_PinConfigure_init_qspi0();
    FTDWriter_PinConfigure_init_sd1();
    FTDWriter_PinConfigure_init_spi0();
...
{
    FTDWriter_PinConfigure_deinit_eadc0();
    FTDWriter_PinConfigure_deinit_emac();
    FTDWriter_PinConfigure_deinit_epwm0();
    FTDWriter_PinConfigure_deinit_i2c1();
    ...
    FTDWriter_PinConfigure_deinit_qspi0();
    FTDWriter_PinConfigure_deinit_sd1();
    FTDWriter_PinConfigure_deinit_spi0();
