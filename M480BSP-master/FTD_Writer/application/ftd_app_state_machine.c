...
#include "ftd_app_writer_manager.h"
#include "stdio.h"
...
static const STATE_HANDLER state_handlers[] = {
    ...
    [APP_BURN_ENGINE] =
    {
        .init = ftd_app_burn_init,
        .process = ftd_app_burn_process,
        .deinit = ftd_app_burn_deinit,
    },
    [APP_WRITER_MANAGER] =
    {
        .init = ftd_app_writer_manager_init,
        .process = ftd_app_writer_manager_process,
        .deinit = ftd_app_writer_manager_deinit,
    }    
};
