...
static void ftd_mw_burn_signal_manager_burn_start_ch1_callback(void)
{
    if (!burn_ch1_state.burn_start_flag)
    {
        ...
        JYMC_LOG_INFO("burn_start_ch1_callback  flag=%d  : time=%d", burn_ch1_state.burn_start_flag, burn_ch1_state.burn_start_trigger_time);
    }
}
...
static void ftd_mw_burn_signal_manager_burn_start_ch2_callback(void)
{
    if (!burn_ch2_state.burn_start_flag)
    {
        ...
        JYMC_LOG_INFO("burn_start_ch2_callback  flag=%d  : time=%d", burn_ch2_state.burn_start_flag, burn_ch2_state.burn_start_trigger_time);
    }
}
...
static void ftd_mw_burn_signal_manager_burn_start_ch3_callback(void)
{
    if (!burn_ch3_state.burn_start_flag)
    {
        ...
        JYMC_LOG_INFO("burn_start_ch3_callback  flag=%d  : time=%d", burn_ch3_state.burn_start_flag, burn_ch3_state.burn_start_trigger_time);
    }
}
...
static void ftd_mw_burn_signal_manager_burn_start_ch4_callback(void)
{
    if (!burn_ch4_state.burn_start_flag)
    {
        ...
        JYMC_LOG_INFO("burn_start_ch4_callback  flag=%d  : time=%d", burn_ch4_state.burn_start_flag, burn_ch4_state.burn_start_trigger_time);
    }
}
...
void ftd_mw_burn_signal_manager_init(void)
{
    ...
    FTD_LOG_INFO("burn signal manager init");
}
    ...
    switch (ch)
    {
        case 0:
        {
            if (burn_ch1_state.burn_start_flag == true)
            {
                ...
                if (now - burn_ch1_state.burn_start_trigger_time >= 50) //100ms后检查状态
                {
                    if (GPIO_GET_VALUE(START_CH1) == 0)
                    {
                        JYMC_LOG_INFO("The time intervals are correct.%d\r\n", now - burn_ch1_state.burn_start_trigger_time);
        ...
        case 1:
        {
            ...
            {
                uint32_t now = ftd_mw_misc_manager_get_time_ms();
                if (now - burn_ch2_state.burn_start_trigger_time >= 50) //100ms后检查状态
                {
        ...
        case 2:
        {
            ...
            {
                uint32_t now = ftd_mw_misc_manager_get_time_ms();
                if (now - burn_ch3_state.burn_start_trigger_time >= 50) //100ms后检查状态
                {
        ...
        case 3:
        {
            ...
            {
                uint32_t now = ftd_mw_misc_manager_get_time_ms();
                if (now - burn_ch4_state.burn_start_trigger_time >= 50) //100ms后检查状态
                {
...
{
    JYMC_LOG_INFO("burn_ch_set_signal: ch=%d, state=%d", ch, state);
    switch (ch)
    {
        case BURN_CH1:
        {
            switch (state)
            {
                case STATE_INIT:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH1, state=STATE_INIT");
                ...
                case STATE_PASS:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH1, state=STATE_PASS");
                ...
                case STATE_NG:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH1, state=STATE_NG");
                ...
                case STATE_BUSY:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH1, state=STATE_BUSY");
                ...
                case STATE_OTHER:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH1, state=STATE_OTHER");
                ...
                default:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH1, state=NOT_DEFINE");
        ...
        case BURN_CH2:
        {
            switch (state)
            {
                case STATE_INIT:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH2, state=STATE_INIT");
                    burn_ch2_state.signal_state = STATE_INIT;
                    GPIO_SET_HIGH(PASS_CH2);
                    GPIO_SET_HIGH(NG_CH2);
                    GPIO_SET_HIGH(BUSY_CH2);
                }
                break;
                case STATE_PASS:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH2, state=STATE_PASS");
                ...
                case STATE_NG:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH2, state=STATE_NG");
                ...
                case STATE_BUSY:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH2, state=STATE_BUSY");
                    burn_ch2_state.signal_state = STATE_BUSY;
                    GPIO_SET_HIGH(PASS_CH2);
                    GPIO_SET_HIGH(NG_CH2);
                    GPIO_SET_LOW(BUSY_CH2);
                }
                break;
                case STATE_OTHER:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH2, state=STATE_OTHER");
                ...
                default:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH2, state=NOT_DEFINE");
        ...
        case BURN_CH3:
        {
            switch (state)
            {
                case STATE_INIT:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH3, state=STATE_INIT");
                    burn_ch3_state.signal_state = STATE_INIT;
                    GPIO_SET_HIGH(PASS_CH3);
                    GPIO_SET_HIGH(NG_CH3);
                    GPIO_SET_HIGH(BUSY_CH3);
                }
                break;
                case STATE_PASS:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH3, state=STATE_PASS");
                ...
                case STATE_NG:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH3, state=STATE_NG");
                ...
                case STATE_BUSY:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH3, state=STATE_BUSY");
                    burn_ch3_state.signal_state = STATE_BUSY;
                    GPIO_SET_HIGH(PASS_CH3);
                    GPIO_SET_HIGH(NG_CH3);
                    GPIO_SET_LOW(BUSY_CH3);
                }
                break;
                case STATE_OTHER:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH3, state=STATE_OTHER");
                ...
                default:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH3, state=NOT_DEFINE");
        ...
        case BURN_CH4:
        {
            switch (state)
            {
                case STATE_INIT:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH4, state=STATE_INIT");
                    burn_ch4_state.signal_state = STATE_INIT;
                    GPIO_SET_HIGH(PASS_CH4);
                    GPIO_SET_HIGH(NG_CH4);
                    GPIO_SET_HIGH(BUSY_CH4);
                }
                break;
                case STATE_PASS:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH4, state=STATE_PASS");
                ...
                case STATE_NG:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH4, state=STATE_NG");
                ...
                case STATE_BUSY:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH4, state=STATE_BUSY");
                    burn_ch4_state.signal_state = STATE_BUSY;
                    GPIO_SET_HIGH(PASS_CH4);
                    GPIO_SET_HIGH(NG_CH4);
                    GPIO_SET_LOW(BUSY_CH4);
                }
                break;
                case STATE_OTHER:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH4, state=STATE_OTHER");
                ...
                default:
                {
                    JYMC_LOG_INFO("burn_ch_set_signal: ch=BURN_CH4, state=NOT_DEFINE");
...
//         JYMC_LOG_INFO("test_count=%d", test_count);
//     }
